...
public class TypeConvertersViewModel extends AndroidViewModel {
    ...
    private void subscribeToDbChanges() {
        ...
        // DONE: replace this with a query that finds books borrowed by Mike in the last 24h
        //mBooks = mDb.bookModel().findBooksBorrowedByName("Mike");


        //gets an instance of Calendar in calendar
        Calendar calendar = Calendar.getInstance();
        //adds the day before today in the calendar
        calendar.add(Calendar.DATE, -1);
        //gets the value of the date for the day before today in the date yestarday
